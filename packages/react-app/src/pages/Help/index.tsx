...
=======
            more maps until the next day. If you'd like to help expand the
            capability of the site and allow for more map generations, you can p
          </p>
          <p className={styles.answerText}>
...
>>>>>>> Stashed changes
        ...
        <h2 className={styles.questionHeader}>How can I make a donation?</h2>
        <p className={styles.answerText}>
          Donations are very much appreciated! Feel free to donate here:{" "}
          <a href="https://www.buymeacoffee.com/tilegenerator">
            https://www.buymeacoffee.com/tilegenerator
          </a>
        </p>
