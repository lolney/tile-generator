    ...
    <div className={styles.page}>
      ...
      <div className={styles.bottom_bar}>
        <div className={styles.outro}>
          ...
          <p className={styles.attribution_header}>
            High-Latitude Elevation data
          </p>
          <p className={styles.paragraph}>
            T. Tadono, H. Nagai, H. Ishida, F. Oda, S. Naito, K. Minakawa, H.
            Iwamoto : Initial Validation of the 30 m-mesh Global Digital Surface
            Model Generated by ALOS PRISM, The International Archives of the
            Photogrammetry, Remote Sensing and Spatial Information Sciences,
            ISPRS, Vol. XLI-B4, pp.157-162, 2016.
          </p>
          <p className={styles.attribution_header}>River data</p>
          <p className={styles.paragraph}>
            Grill, G., Lehner, B., Thieme, M., Geenen, B., Tickner, D.,
            Antonelli, F., Babu, S., Borrelli, P., Cheng, L., Crochetiere, H.
            and Macedo, H.E., 2019. Mapping the world's free-flowing rivers.
